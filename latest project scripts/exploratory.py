...
This script uses curl via subprocess to:
  ...
  2) Call various LLM APIs (OpenAI, Google Gemini, Anthropic) with a concatenated prompt + inlined texts
...
Examples:
  # OpenAI GPT-5
  OPENAI_API_KEY=sk-... python exploratory.py --model gpt-5 --input-file data/amg_credit_agreement_final.txt --output memo_gpt5.md
  ...
  ANTHROPIC_API_KEY=... python exploratory.py --model claude-3-sonnet --input-file data/amg_credit_agreement_final.txt --output memo_claude.md
"""
